...
interface EquipmentPortalProps {
  onBack: () => void;
  initialMode?: 'buy' | 'rent' | 'exchange';
}

const EquipmentPortal: React.FC<EquipmentPortalProps> = ({ onBack, initialMode = 'buy' }) => {
  const [filter, setFilter] = useState('All');
  const [mode, setMode] = useState<'buy' | 'rent' | 'exchange'>(initialMode);
